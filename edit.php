...
<body>
    ...
    <section class="konten">
        <div class="tambah_data1">
            <h1 class="tambah_datatxt">Edit Data</h1>
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input_from">
                    <label for="jenis_produk">Deskripsi</label><br>
...
<?php
    ...
    if($_POST){
        ...
        move_uploaded_file($tmp, 'gambar_buku/' . $gambar_baru);
            $sql = "UPDATE produk_buku SET nama_buku='$judul_buku', pengarang='$pengarang',
                                        harga_buku = '$harga', gambar_buku='$gambar_baru',
